...
describe('getTarget / getAssetName', () => {
	...
	> = [
		...
		['linux', 'arm64', 'cli_0.43.114_linux_arm64.tar.gz', 'tar.gz', 'infisical'],
		['darwin', 'x64', 'cli_0.43.114_darwin_amd64.tar.gz', 'tar.gz', 'infisical'],
		['darwin', 'arm64', 'cli_0.43.114_darwin_arm64.tar.gz', 'tar.gz', 'infisical'],
